            ...
            .enqueue(object : Callback<HistoryResponse> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful){
                        ...
                        // Set ontime and late values to TextViews
                        binding?.tvSumAtt?.text = historyResponse?.ontime.toString()
                        binding?.tvSumLate?.text = historyResponse?.late.toString()
                            ...
                            for (dataHistory in dataHistories!!){
                                ...
                                if (status == 1){
                                    ...
                                    if (calendarHistoryCheckIn != null){
                                        events.add(EventDay(calendarHistoryCheckIn, R.drawable.ic_baseline_check_circle_light_24))
                                    }
